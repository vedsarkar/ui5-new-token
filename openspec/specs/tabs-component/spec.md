...
The Tabs component provides a horizontal tab navigation pattern following the WAI-ARIA Tabs design pattern. It supports controlled and uncontrolled modes, keyboard navigation, disabled tabs, animated active indicators, and full CSS custom property customization. Built with CSS Modules, TypeScript strict typing, and accessibility best practices.
