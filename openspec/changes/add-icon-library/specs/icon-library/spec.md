...
The Icon Library provides a centralized collection of SVG icons and graphics for the Reltio Design System. Icons are uploaded as SVG files and automatically converted to React components. The library supports dual access patterns: direct public URL for documentation/external use, and React component imports for application development.
...
├── {IconName}.tsx     # Generated components
├── {IconName}.stories.tsx
├── index.ts           # Barrel exports
└── IconLibrary.story.mdx
scripts/
└── generate-icons.mjs # Generation script
```

### Dependencies
- Node.js for generation script
