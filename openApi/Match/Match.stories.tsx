...
export const PostReltioApiEntitiesMatches = meta.story({
	name: "POST /reltio/api/{tenantId}/entities/_matches",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/_matches`,
	),
	args: {
		...
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/_matches`,
			body: [
				{
...
export const PostReltioApiEntitiesScoredmatches = meta.story({
	name: "POST /reltio/api/{tenantId}/entities/_scoredmatches",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/_scoredmatches`,
	),
	args: {
		...
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/_scoredmatches`,
			body: [
				{
					uri1: "entities/abc123",
					uri2: "entities/def456",
...
export const PostReltioApiEntitiesVerifyMatches = meta.story({
	name: "POST /reltio/api/{tenantId}/entities/_verifyMatches",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/_verifyMatches`,
	),
	args: {
		...
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/_verifyMatches`,
			body: [
				{
					uri1: "entities/abc123",
					uri2: "entities/def456",
...
export const PostReltioApiEntitiesVerifyUnmerge = meta.story({
	name: "POST /reltio/api/{tenantId}/entities/_verifyUnmerge",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/_verifyUnmerge`,
	),
	args: {
		...
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/_verifyUnmerge`,
			body: [
				{
					uri1: "entities/abc123",
					uri2: "entities/def456",
...
export const GetApiEntitiesIdMatches = meta.story({
	name: "GET /reltio/api/{tenantId}/entities/{id}/_matches",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_matches`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_matches`,
		},
	},
});

export const GetApiEntitiesIdTransitiveMatches = meta.story({
	name: "GET /reltio/api/{tenantId}/entities/{id}/_transitiveMatches",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_transitiveMatches`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_transitiveMatches`,
		},
	},
});

export const GetApiEntitiesIdMatchedEntities = meta.story({
	name: "GET /reltio/api/{tenantId}/entities/{id}/matchedEntities",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/matchedEntities`,
	),
	args: {
		description: `The potential matches returned in the response are the ones that are identified by Suspect match rules. The information returned in the response can be controlled using the parameters supported by this API`,
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/matchedEntities`,
		},
	},
});

export const PostReltioApiEntitiesFindMatchCandidates = meta.story({
	name: "POST /reltio/api/{tenantId}/entities/findMatchCandidates",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/findMatchCandidates`,
	),
	args: {
		description: `This API retrieves match candidates for a given entity ID`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/findMatchCandidates`,
			body: {
...
export const PostReltioApiEntitiesMatchedEntities = meta.story({
	name: "POST /reltio/api/{tenantId}/entities/matchedEntities",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/matchedEntities`,
	),
	args: {
		description: `This API returns the matches for the records provided in the body of the request. The matches returned in the response are the ones that are identified by all match rules. The information returned in the response can be controlled using the parameters supported by this API`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/matchedEntities`,
			body: [
				{
					uri1: "entities/abc123",
					uri2: "entities/def456",
...
export const GetApiEntitiesIdNotMatch = meta.story({
	name: "GET /reltio/api/{tenantId}/entities/{id}/_notMatch",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_notMatch`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_notMatch`,
		},
	},
});

export const PostApiEntitiesIdNotMatch = meta.story({
	name: "POST /reltio/api/{tenantId}/entities/{id}/_notMatch",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_notMatch`,
	),
	args: {
...
export const DeleteApiEntitiesIdNotMatch = meta.story({
	name: "DELETE /reltio/api/{tenantId}/entities/{id}/_notMatch",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_notMatch`,
	),
	args: {
...
export const GetApiEntitiesIdSetAMatch = meta.story({
	name: "GET /reltio/api/{tenantId}/entities/{id}/_setAMatch",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_setAMatch`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_setAMatch`,
		},
	},
});

export const PostApiEntitiesIdSetAMatch = meta.story({
	name: "POST /reltio/api/{tenantId}/entities/{id}/_setAMatch",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_setAMatch`,
	),
	args: {
...
export const DeleteApiEntitiesIdSetAMatch = meta.story({
	name: "DELETE /reltio/api/{tenantId}/entities/{id}/_setAMatch",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/_setAMatch`,
	),
	args: {
...
export const PostReltioApiMatchesBulkNotMatch = meta.story({
	name: "POST /reltio/api/{tenantId}/matches/_bulkNotMatch",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/matches/_bulkNotMatch`,
	),
	args: {
		description: `This API returns results for the records provided in the body of the request.`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/matches/_bulkNotMatch`,
			body: [
				{
					uri1: "entities/abc123",
					uri2: "entities/def456",
...
export const GetApiEntitiesIdMatchDocument = meta.story({
	name: "GET /reltio/api/{tenantId}/entities/{id}/matchDocument",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/matchDocument`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/matchDocument`,
		},
	},
});

export const GetApiEntitiesIdMatchTokens = meta.story({
	name: "GET /reltio/api/{tenantId}/entities/{id}/matchTokens",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/matchTokens`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/matchTokens`,
		},
	},
});

export const GetApiEntitiesIdMatchTokensDetailed = meta.story({
	name: "GET /reltio/api/{tenantId}/entities/{id}/matchTokensDetailed",
	...urlControls(
		`https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/matchTokensDetailed`,
	),
	args: {
		description: `This API explain how each token builds for a particular entity`,
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/api/{tenantId}/entities/{id}/matchTokensDetailed`,
		},
	},
});
...
export const GetReltioToolsMatchingComparatorClasses = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/reltio/tools/matching/comparatorClasses`,
	),
	args: {
		description: `Returns a list of available comparator classes that can be used in the match rule configuration`,
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/tools/matching/comparatorClasses`,
		},
	},
});
...
export const PostReltioToolsMatchingCompare = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/reltio/tools/matching/compare`,
	),
	args: {
		description: `The endpoint returns a comparison result of given values`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/tools/matching/compare`,
			body: {
...
export const PostToolsMatchingCompareMulti = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/reltio/tools/matching/compare/multi`,
	),
	args: {
		description: `The endpoint returns a comparison result of given values`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/tools/matching/compare/multi`,
			body: {
				class: "EqualsComparator",
				value1: "John",
				value2: "John",
...
export const PostReltioToolsMatchingFixGroupingMatchesState = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/reltio/tools/matching/fixGroupingMatchesState`,
	),
	args: {
		description: `Fixes grouping matches and associations state for provided entity and association IDs`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/tools/matching/fixGroupingMatchesState`,
			body: {},
		},
	},
});
...
export const GetReltioToolsMatchingMatchTokenClasses = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/reltio/tools/matching/matchTokenClasses`,
	),
	args: {
		description: `Returns a list of available match token classes that can be used in the match rule configuration`,
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/reltio/tools/matching/matchTokenClasses`,
		},
	},
});
...
export const PostReltioToolsMatchingMatchTokenIntersections = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/reltio/tools/matching/matchTokenIntersections`,
	),
	args: {
		description: `This endpoint calculates the token intersection for a given pair of values using the supplied token class`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/tools/matching/matchTokenIntersections`,
			body: {
...
export const PostReltioToolsMatchingMatchTokens = meta.story({
	...
	args: {
		...
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/tools/matching/matchTokens`,
			body: {
				values: ["John", "Doe"],
			},
		},
...
export const PostToolsMatchingMatchTokensMulti = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/reltio/tools/matching/matchTokens/multi`,
	),
	args: {
		description: `This API builds match token phrases for given values based on tokenization classes.`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/tools/matching/matchTokens/multi`,
			body: {
				values: ["John", "Doe"],
			},
		},
...
export const PostReltioToolsMatchingTokensExplanation = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/reltio/tools/matching/tokensExplanation`,
	),
	args: {
		description: `Explains how match tokens are built for any given entity`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/reltio/tools/matching/tokensExplanation`,
			body: {
				entityUri: "entities/abc123",
			},
		},
