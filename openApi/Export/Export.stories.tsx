...
export const PostExportActivities = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/export/{tenantId}/activities`,
	),
	args: {
		...
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/services/jobs/export/{tenantId}/activities`,
			body: {
				format: "CSV",
...
export const PostExportEntities = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/export/{tenantId}/entities`,
	),
	args: {
		description: `This API exports entities from a tenant, uploads a CSV file or JSON file to the appropriate storage, and sends a link to the exported data (if post-processing is enabled and the partSize parameter was not specified) or a link to the Export Console UI page (in the other cases) to your email address.Note: For details about S3, GCS, or an Azure Storage destination for export, please see Storing Export Results. Only one storage destination can be specified for one export request.`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/services/jobs/export/{tenantId}/entities`,
			body: {
				format: "CSV",
				filter: "equals(type,'configuration/entityTypes/Individual')",
			},
...
export const PostExportEntitiesCrosswalksTree = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/export/{tenantId}/entities/_crosswalksTree`,
	),
	args: {
		...
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/services/jobs/export/{tenantId}/entities/_crosswalksTree`,
			body: {
				format: "CSV",
				filter: "equals(type,'configuration/entityTypes/Individual')",
			},
...
export const PostExportEntitiesSegments = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/export/{tenantId}/entities/segments`,
	),
	args: {
		...
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/services/jobs/export/{tenantId}/entities/segments`,
			body: {
				format: "CSV",
				filter: "equals(type,'configuration/entityTypes/Individual')",
			},
...
export const PostExportHierarchies = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/export/{tenantId}/hierarchies`,
	),
	args: {
		...
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/services/jobs/export/{tenantId}/hierarchies`,
			body: {
				format: "CSV",
				filter: "equals(type,'configuration/entityTypes/Individual')",
			},
...
export const PostExportRelations = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/export/{tenantId}/relations`,
	),
	args: {
		description: `This API exports relations from a tenant, uploads a CSV file or JSON file to the appropriate storage, and sends a link to the exported data (if post-processing is enabled and the partSize parameter was not specified) or a link to the Export Console UI page (in the other cases) to your email address.Note: For details about S3, GCS, or an Azure Storage destination for export, please see Storing Export Results. Only one storage destination can be specified for one export request.`,
		request: {
			method: "POST",
			url: `https://{environment}.reltio.com/services/jobs/export/{tenantId}/relations`,
			body: {
				format: "CSV",
				filter: "equals(type,'configuration/entityTypes/Individual')",
			},
...
export const GetTasks = meta.story({
	name: "GET /tasks",
	...urlControls(`https://{environment}.reltio.com/services/jobs/tasks`),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/tasks`,
		},
	},
});
...
export const GetTasksTotal = meta.story({
	...
	...urlControls(`https://{environment}.reltio.com/services/jobs/tasks/_total`),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/tasks/_total`,
		},
	},
});
...
export const GetTasksTaskId = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/tasks/{taskId}`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/tasks/{taskId}`,
		},
	},
});
...
export const GetTasksTaskIdManifest = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/tasks/{taskId}/_manifest`,
	),
	args: {
		description: `This API provides information about the exported files for a particular export task.`,
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/tasks/{taskId}/_manifest`,
		},
	},
});
...
export const PutTasksTaskIdPause = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/tasks/{taskId}/_pause`,
	),
	args: {
		...
		request: {
			method: "PUT",
			url: `https://{environment}.reltio.com/services/jobs/tasks/{taskId}/_pause`,
		},
	},
});
...
export const PutTasksTaskIdResume = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/tasks/{taskId}/_resume`,
	),
	args: {
		...
		request: {
			method: "PUT",
			url: `https://{environment}.reltio.com/services/jobs/tasks/{taskId}/_resume`,
		},
	},
});
...
export const PutTasksTaskIdStop = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/tasks/{taskId}/_stop`,
	),
	args: {
		...
		request: {
			method: "PUT",
			url: `https://{environment}.reltio.com/services/jobs/tasks/{taskId}/_stop`,
		},
	},
});
...
export const GetTasksHistory = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/tasks/history`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/tasks/history`,
		},
	},
});
...
export const GetTasksHistoryTotal = meta.story({
	...
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/tasks/history/_total`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/tasks/history/_total`,
		},
	},
});
...
export const GetTasks2 = meta.story({
	name: "GET /tasks",
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/{tenantId}/tasks`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/{tenantId}/tasks`,
		},
	},
});
...
export const GetTasksTotal2 = meta.story({
	name: "GET /tasks/_total",
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/_total`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/_total`,
		},
	},
});
...
export const GetTasksTaskId2 = meta.story({
	name: "GET /tasks/{taskId}",
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/{taskId}`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/{taskId}`,
		},
	},
});
...
export const PutTasksTaskIdPause2 = meta.story({
	name: "PUT /tasks/{taskId}/_pause",
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/{taskId}/_pause`,
	),
	args: {
		...
		request: {
			method: "PUT",
			url: `https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/{taskId}/_pause`,
		},
	},
});
...
export const PutTasksTaskIdResume2 = meta.story({
	name: "PUT /tasks/{taskId}/_resume",
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/{taskId}/_resume`,
	),
	args: {
		...
		request: {
			method: "PUT",
			url: `https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/{taskId}/_resume`,
		},
	},
});
...
export const PutTasksTaskIdStop2 = meta.story({
	name: "PUT /tasks/{taskId}/_stop",
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/{taskId}/_stop`,
	),
	args: {
		...
		request: {
			method: "PUT",
			url: `https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/{taskId}/_stop`,
		},
	},
});
...
export const GetTasksHistory2 = meta.story({
	name: "GET /tasks/history",
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/history`,
	),
	args: {
		...
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/history`,
		},
	},
});
...
export const GetTasksHistoryTotal2 = meta.story({
	name: "GET /tasks/history/_total",
	...urlControls(
		`https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/history/_total`,
	),
	args: {
		description: `This API is available to Administrator and Tenant's Administrator and returns the total count of export tasks for the specified tenant with the following statuses: CANCELED - Indicates that the task was canceled.COMPLETED - Indicates that the task was completed.FAILED - Indicates that an error occurred during execution of a task.`,
		request: {
			method: "GET",
			url: `https://{environment}.reltio.com/services/jobs/{tenantId}/tasks/history/_total`,
		},
	},
});
