...
Add a self-describing component-discovery CLI to `@reltio/design`, and ship the agent skill for adopting those components in the new standalone `@reltio/skills` package.
