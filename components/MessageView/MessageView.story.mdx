...
import * as MessageViewStories from "./MessageView.stories";
import schema from "./MessageView.schema.json";

<Meta of={MessageViewStories} />

# MessageView

```tsx
import { MessageView } from "@reltio/design/components";
```
