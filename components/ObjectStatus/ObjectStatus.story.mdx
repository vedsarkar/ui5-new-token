...
import * as ObjectStatusStories from "./ObjectStatus.stories";
import schema from "./ObjectStatus.schema.json";

<Meta of={ObjectStatusStories} />

# ObjectStatus

```tsx
import { ObjectStatus } from "@reltio/design/components";
```
