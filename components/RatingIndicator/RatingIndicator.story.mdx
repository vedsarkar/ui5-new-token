...
import * as RatingIndicatorStories from "./RatingIndicator.stories";
import schema from "./RatingIndicator.schema.json";

<Meta of={RatingIndicatorStories} />

# RatingIndicator

```tsx
import { RatingIndicator } from "@reltio/design/components";
```
